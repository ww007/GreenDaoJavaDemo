...
public class StudentItemDao extends AbstractDao<StudentItem, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property StudentID = new Property(1, Integer.class, "StudentID", false, "STUDENT_ID");
    ...
    public StudentItem readEntity(Cursor cursor, int offset) {
        StudentItem entity = new StudentItem( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getInt(offset + 1), // StudentID
    ...
    public void readEntity(Cursor cursor, StudentItem entity, int offset) {
        ...
        entity.setStudentID(cursor.isNull(offset + 1) ? null : cursor.getInt(offset + 1));
